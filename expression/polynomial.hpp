...
#if /*__has_include(<boost/multiprecision/cpp_int.hpp>) || __has_include("boost/multiprecision/cpp_int.hpp>")*/0
...
namespace expression {
	...
	template<typename coefficient_type = default_type, typename variable_type = default_type>
	inline constexpr polynomial<coefficient_type, variable_type> operator+(const polynomial<coefficient_type, variable_type>& p1, const polynomial<coefficient_type, variable_type>& p2) {
	...
	inline constexpr polynomial<coefficient_type, variable_type> operator+(const polynomial<coefficient_type, variable_type>& p1, const number_type& v) {
		polynomial<coefficient_type, variable_type> p = p1;
	...
	template<typename number_type, typename coefficient_type = default_type, typename variable_type = default_type>
	inline constexpr polynomial<coefficient_type, variable_type> operator+(const number_type& v, const polynomial<coefficient_type, variable_type>& p1) {
		polynomial<coefficient_type, variable_type> p = p1;
		p += polynomial<coefficient_type, variable_type>(v);
		return p;
	}
